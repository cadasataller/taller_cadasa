...
<template>
  <section class="flex min-h-0 min-w-0 flex-1 flex-col rounded-lg border border-gray-200 bg-[#FAF9F5] shadow-sm">
    ...
    <AceiteDetailDrawer :open="catalogo.drawerOpen.value" :mode="catalogo.modo.value" :item="catalogo.original.value" :draft="catalogo.draft.value" :has-changes="catalogo.hasChanges.value" :can-submit="catalogo.canSubmit.value" :can-save="catalogo.canSave.value" :saving="catalogo.guardando.value" :field-errors="catalogo.fieldErrors.value" :save-error="saveError" @update-draft="catalogo.updateDraft" @blur-name="catalogo.validateName" @request-close="catalogo.solicitarCierre" @cancel="catalogo.solicitarCierre" @submit="catalogo.submit" />
