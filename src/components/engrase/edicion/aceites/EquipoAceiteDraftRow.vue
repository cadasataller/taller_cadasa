  ...
  >
    ...
    <div class="flex gap-1.5 sm:justify-end">
      <button
        v-if="aceite.estadoOperacion !== 'pendiente_eliminacion'"
        type="button"
        class="inline-flex min-h-9 cursor-pointer items-center gap-1 rounded-md border border-second-deep px-2 text-xs font-semibold text-main hover:bg-second"
      ...
      <button
        v-if="aceite.estadoOperacion !== 'pendiente_eliminacion'"
        type="button"
        class="inline-flex min-h-9 cursor-pointer items-center gap-1 rounded-md border border-danger/30 px-2 text-xs font-semibold text-danger hover:bg-danger-bg"
