    ...
    >
      ...
      <thead class="bg-gray-50 text-gray-600">
        <tr class="h-9 border-b border-gray-200">
          ...
          <th :aria-sort="ariaSort('nombre')">
            <button
              type="button"
              class="inline-flex h-9 cursor-pointer items-center gap-1.5 px-3 font-semibold hover:text-main focus-visible:outline-2 focus-visible:outline-main"
      ...
      <tbody>
        <tr
          ...
          :class="
            selectedId === item.id
              ? 'bg-main/7 shadow-[inset_3px_0_0_var(--color-main)]'
              : 'bg-white'
          "
          tabindex="0"
        ...
        >
          <td class="px-3">
            <span
              class="grid h-7 w-7 place-items-center rounded-md bg-main/7 text-main"
            >
              <component
          ...
          <td class="truncate px-3 text-sm font-semibold text-main">
            {{ item.nombre }}
          </td>
          <td class="px-3"><TipoFiltroEstadoBadge :activo="item.activo" /></td>
          <td class="px-3 font-medium tabular-nums text-gray-600">
            {{ formatoEquipos(item.impacto.totalEquipos) }}
          </td>
          <td class="px-2 text-main">
