...
const props = defineProps<{ open: boolean; mode: CatalogoFiltroEditorMode; item: CatalogoFiltroItem | null; draft: CatalogoFiltroGuardarInput | null; hasChanges: boolean; canSubmit: boolean; saving: boolean; fieldErrors: CatalogoFiltroFieldErrors; saveError?: string | null }>();
