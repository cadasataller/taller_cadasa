...
const emit = defineEmits<{
  ...
  (e: "zrClick", params: ElementEvent): void;
  (e: "legendselectchanged", params: SelectChangedEvent): void;
}>();
...
const initChart = () => {
  ...
  chartInstance.value = echarts.init(chartRef.value, props.theme || null, {
    renderer: "svg",
  });
