  ...
  it("carga la foto actual solo para los source_id cargados y válidos", async () => {
      ...
      data: [
        {
          ...
          movement_status_update: "2026-08-29T17:38:02+00:00",
          connection_status: "active",
          ignition: true,
          ignition_update: "2026-08-29T17:38:02+00:00",
          velocidad: 0,
        },
        {
          source_id: 0,
    ...
    await expect(
    ...
    ).resolves.toEqual([
      {
        ...
        movementStatusUpdatedAt: "2026-08-29T17:38:02+00:00",
        connectionStatus: "active",
        ignition: true,
        ignitionUpdatedAt: "2026-08-29T17:38:02+00:00",
        speed: 0,
      },
    ]);
